...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_ball1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_keeper_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_net_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("assets/images/ball1.png") @:noCompletion #if display private #end class __ASSET__assets_images_ball1_png extends lime.graphics.Image {}
@:keep @:image("assets/images/clouds.png") @:noCompletion #if display private #end class __ASSET__assets_images_clouds_png extends lime.graphics.Image {}
@:keep @:file("assets/images/images-go-here.txt") @:noCompletion #if display private #end class __ASSET__assets_images_images_go_here_txt extends haxe.io.Bytes {}
@:keep @:image("assets/images/keeper.png") @:noCompletion #if display private #end class __ASSET__assets_images_keeper_png extends lime.graphics.Image {}
@:keep @:image("assets/images/net.png") @:noCompletion #if display private #end class __ASSET__assets_images_net_png extends lime.graphics.Image {}
